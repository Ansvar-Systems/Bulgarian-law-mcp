...
## [1.0.0] - 2026-02-21
### Added
- Initial release of Bulgarian Law MCP
- `search_legislation` tool for full-text search across Bulgarian legislation
...
- `get_bulgarian_implementations` tool for finding national EU implementations
...
[1.0.0]: https://github.com/Ansvar-Systems/Bulgarian-law-mcp/releases/tag/v1.0.0
