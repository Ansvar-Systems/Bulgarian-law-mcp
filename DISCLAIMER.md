...
- **No Attorney-Client Relationship**: Use of this Tool does not create an attorney-client relationship (мандатно правоотношение)
...
If you are a lawyer (адвокат), legal researcher, or other legal professional:

- **Malpractice Risk**: Relying on unverified information from this Tool in professional legal work may constitute professional malpractice (професионална небрежност)
...
- **Professional Rules**: Members of the Bulgarian Bar Association (Висш адвокатски съвет — ВАдС) and regional bar councils (адвокатски колегии) must comply with applicable professional conduct rules (Кодекс за професионална етика на адвокатите) when using AI tools
...
1. Checking the official source (lex.bg — официален правно-информационен портал)
2. Verifying the provision is currently in force (в сила) and has not been amended (изменен) or repealed (отменен)
3. Reading the full context of cited provisions
4. Consulting case law (съдебна практика) and explanatory materials (мотиви, доклади на комисии) for interpretation
...
This Tool aggregates data from official Bulgarian legal databases. However:

| Source Type | Authority Level | Use Case |
|------------|----------------|----------|
| **lex.bg** | Authoritative | Statute text, consolidated legislation (primary reference) |
| **Ciela Norma (ciela.com)** | Authoritative (commercial) | Annotated legislation, court decisions |
...
- Ciela Norma (ciela.com), Apis (apis.bg), Sibi (sibi.bg)

These services provide editorial oversight, comprehensive annotations (коментари), and professional-grade currency guarantees that this Tool **cannot** provide.
...
- Bulgarian law changes continuously through new statutes (закони), amendments (изменения и допълнения), and court decisions (решения)
...
- Even "fresh" data may be outdated if recent amendments were published in the Държавен вестник (State Gazette)
- Staleness warnings do not guarantee completeness or accuracy
- Always check official sources for the current legal position (актуална правна уредба)

### Amendments and Repeals

- A provision marked "in force" may have been:
  - Amended (изменен) after the last database update
  - Repealed (отменен) but not yet removed from the database
  - Subject to transitional rules (преходни разпоредби) affecting its applicability
...
1. **Complete case law** — Coverage of ВКС (Върховен касационен съд), ВАС (Върховен административен съд), and lower court decisions is limited; do not rely solely on this for case law research (проучване на съдебна практика)
2. **Historical statute versions** — Limited availability of historical provision wording (сравнение на редакции)
3. **Legal commentary** — No editorial annotations (коментари), academic commentary (правна доктрина), or practice guides
4. **Unpublished decisions** — Lower court decisions and administrative rulings (административни актове) largely absent
5. **Full legislative history** — Limited coverage of parliamentary materials (законопроекти, доклади на комисии, стенограми от НС)
...
- **Context Missing**: Without commentary (коментар) and legislative materials, interpretation may be incorrect
...
- This includes but is not limited to:
  - Professional malpractice claims (искове за професионална небрежност)
  - Lost cases or adverse judgments
  - Client harm from erroneous advice
  - Regulatory sanctions from bar authorities (дисциплинарно производство)
  - Reputational damage
...
- **Sensitive Matters**: For privileged legal matters (адвокатска тайна), consider on-premise deployment

### Competence and Diligence

Using this Tool does not reduce your professional obligations to:

- Exercise independent legal judgment (самостоятелна правна преценка)
- Conduct thorough legal research using authoritative sources
- Stay current with legal developments
- Provide competent representation (добросъвестно и компетентно представителство)

## Recommended Workflow for Professional Use

1. **Initial Research**: Use Tool for preliminary research and hypothesis generation
2. **Official Verification**: Cross-check ALL results with official sources (lex.bg)
3. **Commercial Databases**: Use professional legal databases (Ciela Norma, Apis) for authoritative, annotated versions
...
6. **Update Check**: Before finalizing legal work, check for recent amendments in the Държавен вестник

## Changes to This Disclaimer

This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Bulgarian-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Bulgarian-law-mcp/issues
...
- **ALWAYS VERIFY** all legal information with official sources (lex.bg)
...
- **COMPLY** with Висш адвокатски съвет (ВАдС) professional ethics rules regarding AI tool use and client confidentiality
- **DISCLOSE** to clients if required by professional rules (Кодекс за професионална етика на адвокатите)
