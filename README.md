...
MCP server for Bulgarian Law — 1,997 statutes from www.parliament.bg

[![License: Apache 2.0](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](LICENSE)
[![MCP](https://img.shields.io/badge/MCP-spec--compliant-green.svg)](https://modelcontextprotocol.io)
[![Jurisdiction](https://img.shields.io/badge/Jurisdiction-BG-informational.svg)](#coverage)
...
- **Corpus:** Bulgarian Law — 1,997 statutes, 17,103 provisions
...
```bash
git clone https://github.com/Ansvar-Systems/Bulgarian-law-mcp.git
...
|---|---|---|---|---|---|---|---|
| [Parliament of the Republic of Bulgaria API](https://www.parliament.bg) | https://www.parliament.bg | [Terms](https://www.parliament.bg/bg/laws) | government_terms | Recommended | Yes | Yes | Bulgarian National Assembly publishes statutory texts. |
...
Issues: [github.com/Ansvar-Systems/Bulgarian-law-mcp/issues](https://github.com/Ansvar-Systems/Bulgarian-law-mcp/issues) · Security: <security@ansvar.eu>
