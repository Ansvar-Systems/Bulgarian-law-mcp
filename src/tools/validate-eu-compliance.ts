/**
 * validate_eu_compliance — Check EU alignment status for an Bulgarian statute.
 */
  ...
  if (euRefCount === 0) {
    return {
      results: {
        ...
        eu_references_found: 0,
        warnings: [],
        recommendations: ['No EU cross-references found for this Bulgarian statute. Poland is not an EU member; EU references indicate comparable frameworks rather than transposition obligations.'],
      },
      _metadata: generateResponseMetadata(db),
    };
  }
