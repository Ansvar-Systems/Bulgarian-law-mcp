  ...
  if (euRefCount === 0) {
    return {
      results: {
        ...
        eu_references_found: 0,
        warnings: [],
        recommendations: ['No EU cross-references found for this Bulgarian statute. Bulgaria is an EU Member State; EU references indicate transposition obligations.'],
      },
      _metadata: generateResponseMetadata(db),
    };
  }
